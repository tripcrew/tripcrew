...
const documents = {
  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: ['TripCrew는 여행 정보를 제공하기 위해 한국관광공사 TourAPI 등 외부 데이터 제공자의 정보를 활용합니다. 이동 경로 계산이나 AI 챗봇 기능을 사용할 때는 요청 처리에 필요한 여행 관련 입력값이 해당 기능의 외부 제공자에게 전달될 수 있습니다.', 'TripCrew는 법령상 근거가 있거나 이용자가 동의한 경우를 제외하고 개인정보를 판매하거나 제3자에게 제공하지 않습니다.']
      },
      {
        title: '4. 안전성 확보 조치',
  ...
  dataSources: {
    title: '공공데이터 출처',
    description: 'TripCrew는 여행 정보 탐색에 아래 데이터와 연계 서비스를 활용합니다.',
    sections: [
      {
        title: '한국관광공사 TourAPI',
        paragraphs: ['관광지의 기본 정보, 지역·분류 정보, 이미지 등 여행지 탐색에 필요한 공공 관광 데이터를 제공합니다. 데이터의 최신성과 정확성은 원 제공처의 갱신 상황에 따라 달라질 수 있습니다.']
      },
      {
        title: '외부 연계 서비스',
        paragraphs: ['여행 계획의 이동 경로 계산, 날씨·일출·일몰 정보 또는 AI 여행 추천은 기능 설정에 따라 외부 서비스의 데이터를 활용할 수 있습니다. 제공 범위와 응답 결과는 각 제공처의 운영 상태 및 정책에 영향을 받을 수 있습니다.']
      },
      {
        title: '이용 시 유의 사항',
