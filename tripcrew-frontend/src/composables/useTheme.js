 ...
 * - 선택은 localStorage('tripcrew-theme')에 영속화. 저장값이 없으면 **라이트가 기본**(시스템 설정 무시).
 *   index.html 의 pre-paint 스크립트와 동일 규칙(`saved === 'dark'` → 다크).
...
function resolveInitial() {
  ...
  // 명시적 'dark' 저장만 다크, 그 외(저장 없음·'light')는 라이트 기본
